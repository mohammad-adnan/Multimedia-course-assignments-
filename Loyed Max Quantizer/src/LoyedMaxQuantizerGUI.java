...
public class LoyedMaxQuantizerGUI extends JFrame implements ActionListener {
	...
	String src,des;
	LoyedMaxQuantizerWithFiles loyedMaxQuantizerWithFiles=new LoyedMaxQuantizerWithFiles();
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LoyedMaxQuantizerGUI frame = new LoyedMaxQuantizerGUI();
	 ...
	 * Create the frame.
	 */
	public LoyedMaxQuantizerGUI() {
		setTitle("Loyed max quantizer");
		...
		compress.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				loyedMaxQuantizerWithFiles.compress(src, des,n);
			}
		});
		...
		deCompress.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				loyedMaxQuantizerWithFiles.deCompress(src, des);
			}
		});
		...
		btnShowSrc.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						try {
							ShowFile frame = new ShowFile(loyedMaxQuantizerWithFiles.showFile(src));
							frame.setVisible(true);
						} catch (Exception e) {
							e.printStackTrace();
						}
		...
		btnShowDis.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						try {
							ShowFile frame = new ShowFile(loyedMaxQuantizerWithFiles.showFile(des));
							frame.setVisible(true);
						} catch (Exception e) {
							e.printStackTrace();
						}
