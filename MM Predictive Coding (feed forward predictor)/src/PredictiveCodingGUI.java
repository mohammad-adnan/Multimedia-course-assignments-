...
public class PredictiveCodingGUI extends JFrame implements ActionListener {
	...
	String src,des;
	PredictiveCodingWithFile PredictiveCodingCom=new PredictiveCodingWithFile();
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PredictiveCodingGUI frame = new PredictiveCodingGUI();
	 ...
	 * Create the frame.
	 */
	public PredictiveCodingGUI() {
		setTitle("Predictive Coding");
		...
		compress.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				PredictiveCodingCom.compress(src, des,n);
			}
		});
		...
		deCompress.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PredictiveCodingCom.deCompress(src, des);
			}
		});
		...
		btnShowSrc.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						try {
							ShowFile frame = new ShowFile(PredictiveCodingCom.showFile(src));
							frame.setVisible(true);
						} catch (Exception e) {
							e.printStackTrace();
						}
		...
		btnShowDis.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						try {
							ShowFile frame = new ShowFile(PredictiveCodingCom.showFile(des));
							frame.setVisible(true);
						} catch (Exception e) {
							e.printStackTrace();
						}
